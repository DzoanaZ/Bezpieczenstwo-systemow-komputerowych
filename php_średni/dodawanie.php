	...
	<div class="wrapper">
		...
		if(isset($_POST['Submit'])) {    
			...
			if(empty($kat) || empty($opis) || empty($link)) {                
				...
				$rezultat = mysqli_query($polaczenie, "INSERT INTO przyklady(kat,opis,link) VALUES('$kat','$opis','$link')");
				
				echo "<font color='green'>Dodano przykład.";
			}
		}
		?>
		</div>
		...
		<div class="footer" font color='black'>Programowanie w App Inventor 2</div>
	</div>
